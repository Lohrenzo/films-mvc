...
<body class="pb-3 no-select">
	...
	<h1 class="text-center text-[2rem] font-bold">All Films</h1>
				...
				<tr class="p-6 gap-4 border-b last:border-b-0 last:pb-4 w-full text-sm text-left">
					...
					<td class="p-2">
						<form action="./delete" method="POST">
							...
							<button type="submit" class="delete-btn bg-red-800 px-4 py-2 text-white hover:bg-red-900 sm:px-8 sm:py-3 rounded-lg"><i class="fa-solid fa-trash-can"></i></button>
						</form>
					</td>
					<td class="p-2">
